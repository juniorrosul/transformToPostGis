...
class Ui_TransformToPostgis(object):
    def setupUi(self, TransformToPostgis):
        ...
        QtCore.QObject.connect(
            self.btncancel,
            QtCore.SIGNAL(
                _fromUtf8("clicked(bool)")),
            TransformToPostgis.reject)
    ...
    def retranslateUi(self, TransformToPostgis):
        TransformToPostgis.setWindowTitle(
        ...
        self.label1.setText(QtGui.QApplication.translate(
            "TransformToPostgis",
            "Input File:",
            None,
            QtGui.QApplication.UnicodeUTF8))

        self.label2.setText(QtGui.QApplication.translate(
            "TransformToPostgis",
            "Update Options:",
            None,
            QtGui.QApplication.UnicodeUTF8))

        self.label3.setText(QtGui.QApplication.translate(
            "TransformToPostgis",
            "Input File Type:",
            None,
            QtGui.QApplication.UnicodeUTF8))

        self.btnok.setText(QtGui.QApplication.translate(
            "TransformToPostgis",
            "OK",
            None,
            QtGui.QApplication.UnicodeUTF8))

        self.btncancel.setText(QtGui.QApplication.translate(
            "TransformToPostgis",
            "CANCEL",
            None,
            QtGui.QApplication.UnicodeUTF8))

        self.btnbrowse.setText(QtGui.QApplication.translate(
            "TransformToPostgis",
            "Browse",
            None,
            QtGui.QApplication.UnicodeUTF8))

        self.horizontalGroupBox.setTitle(QtGui.QApplication.translate(
            "TransformToPostgis",
            "Input Files",
            None,
            QtGui.QApplication.UnicodeUTF8))

        self.horizontalGroupBox1.setTitle(QtGui.QApplication.translate(
            "TransformToPostgis",
            "Output",
            None,
            QtGui.QApplication.UnicodeUTF8))
